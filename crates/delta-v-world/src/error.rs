...
//! Typed error enum for world definition loading failures.
//!
//! See ADR-0016 (Error handling strategy).

use std::path::PathBuf;

/// Errors that can occur while loading or validating a world definition file.
#[derive(Debug, thiserror::Error)]
pub enum WorldError {
    /// A required world file could not be read.
    ...
    /// The parsed JSON did not satisfy the world schema.
